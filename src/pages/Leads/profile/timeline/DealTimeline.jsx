        ...
        return <TimelineComponentNoDot key={item.id}>
            <Box sx={{p:2  , bgcolor:'#F9F9F9' , borderRadius:'5px'}}>
                ...
                <Box sx={{display:'flex', gap:'2px', py:'5px' }}>
                    ...
                    <Typography variant='subtitle1' sx={{fontSize:'13px' , lineHeight:1.4 , fontWeight:500 , pr:'12px' , borderRight:'1px solid #707178' , color:'#3A6685'}}><span style={{color:'#707178',fontWeight:400}}>End Date : </span>{item.enddate}</Typography>
                    <Typography variant='subtitle1' sx={{fontSize:'13px' , lineHeight:1.4 , fontWeight:500 , pl:'12px', borderRight:'1px solid #707178', pr:'12px'  , color: item.status === 'Completed' ?'#008D43':'#3E9FD7'}}><span style={{color:'#707178',fontWeight:400}}>Status : </span>{item.status}</Typography>
                    <Typography variant='subtitle1' sx={{fontSize:'13px' , lineHeight:1.4 , fontWeight:500 , pl:'12px'  , color: item.stage === 'Won' ?'#008D43':item.stage ==='Lost'?'#E33C4E':'#3E9FD7'}}><span style={{color:'#707178',fontWeight:400}}>Stage : </span>{item.stage}</Typography>
                </Box>
                }
            </Box>
